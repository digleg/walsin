...
const itemTarget = {
  hover(props, monitor, component) {
    ...
    let penPercent = 0.5; // Percentage distance into next item before swap
...
class ReorderableListItem extends Component {
  ...
  render() {
    ...
    const {
      ...
      renameReport,
      moveItem,
      connectDragPreview, // omit pass hackAutoComplete
      ...props
    } = this.props;
...
export default DropTarget(dndType, itemTarget, connectTarget)(
  DragSource(dndType, itemSource, connectSource)(ReorderableListItem)
);
