...
// import messages from '../../../containers/PersonnelPage/messages';

class SecurityBarChart extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {};
  }
  ...
  render() {
    ...
    const formattedMessage = intl.formatMessage({ id: 'MERC.containers.PersonnelPage.user' });
    const formattedWorkListNum = intl.formatMessage({ id: 'MERC.containers.PersonnelPage.userListNum' });
    let ticksMax = 11;
    if (dataInput !== null) {
...
SecurityBarChart.propTypes = {
  dataInput: PropTypes.array,
  intl: intlShape.isRequired,
};

// export default SecurityBarChart;
export default compose(injectIntl)(SecurityBarChart);
